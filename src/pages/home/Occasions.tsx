...
function useInView(
  options: IntersectionObserverInit = EMPTY_OPTIONS,
...
const CARD_STYLES: Array<{
  ...
  {
    icon: HiOutlineHeart,
    gradient: "from-pink-900/40 to-rose-950/60",
    accent: "#fb7185",
  },
  {
    icon: HiOutlineGift,
    gradient: "from-[#5a1a1a]/60 to-[#2a0a0a]/80",
    accent: "#ff9b88",
  },
];
...
const STATS = [
  {
    value: "25K+",
    labelKey: "occasionPage.statsDelivered",
    icon: HiOutlineSparkles,
  },
  {
    value: "100%",
    labelKey: "occasionPage.statsFreshness",
    icon: HiOutlineShieldCheck,
  },
  {
    value: "1hr",
    labelKey: "occasionPage.statsDelivery",
    icon: HiOutlineTruck,
  },
];
...
const HOW_IT_WORKS = [
  {
    step: 1,
    titleKey: "occasionPage.howStep1Title",
    descriptionKey: "occasionPage.howStep1Description",
    icon: HiOutlineHeart,
  },
  {
    step: 2,
    titleKey: "occasionPage.howStep2Title",
    descriptionKey: "occasionPage.howStep2Description",
    icon: HiOutlineGift,
  },
  {
    step: 3,
    titleKey: "occasionPage.howStep3Title",
    descriptionKey: "occasionPage.howStep3Description",
    icon: HiOutlineTruck,
  },
];
...
function Counter({ value }: { value: string }) {
  ...
  if (isNaN(numeric))
    return <span ref={ref as React.Ref<HTMLDivElement>}>{value}</span>;
  return (
  ...
  const allStats = useMemo(
    () => [
      STATS[0],
      {
        ...
        labelKey: "occasionPage.statsOccasionTypes",
        icon: HiOutlineHeart,
      },
      STATS[1],
      STATS[2],
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Find beautiful flowers for birthdays, anniversaries, celebrations, and special moments."
        />
      </Helmet>
      ...
      <main className="relative isolate min-h-screen overflow-hidden text-[#fff6f4]">
        ...
        <div className="pointer-events-none fixed inset-0 -z-10">
          ...
          <div
            className="absolute -right-20 top-56 h-80 w-80 rounded-full bg-[#d9b56f]/5 blur-3xl animate-pulse-soft"
        ...
        <section className="relative flex min-h-screen flex-col items-center justify-center px-4 pb-12 pt-28 sm:px-6 lg:px-10">
          <div className="mx-auto flex w-full max-w-4xl flex-col items-center text-center">
            ...
            <Reveal delay={480}>
              <a
                href="#stats"
                className="mt-14 flex flex-col items-center gap-1 text-[#d9b56f]/30 transition-colors hover:text-[#d9b56f]/50"
              >
                <span className="text-[9px] uppercase tracking-[0.32em]">
                  {t("occasionPage.scrollLabel")}
                </span>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div>
                        ...
                        <p className="mt-0.5 text-[9px] uppercase tracking-[0.18em] text-[#b9978f]">
                          {t(stat.labelKey)}
                        </p>
                      </div>
                    </div>
            ...
            {isLoading ? (
              <div className="grid gap-5 sm:grid-cols-2 xl:grid-cols-4">
                {Array.from({ length: 8 }).map((_, i) => (
                  <div
                    key={i}
                    className="h-[22rem] animate-pulse rounded-2xl border border-[#3a1214]/40 bg-[#0d0405]/60"
                  />
                ))}
              </div>
            ) : (
              <div className="grid gap-5 sm:grid-cols-2 xl:grid-cols-4">
                {displayCategories.map((category, index) => {
                  ...
                  const description =
                    ...
                    t("occasionSection.dynamicDescription", {
                      category: title,
                    });
                    ...
                    <Reveal key={category.id} delay={Math.min(index * 70, 350)}>
                      ...
                      >
                        ...
                        <div
                          ...
                          style={{
                            background: `radial-gradient(ellipse at 50% 100%, ${accent}18, transparent 70%)`,
                          }}
                        />
                  ...
                  <Reveal key={item.step} delay={i * 100}>
                    <div className="group relative overflow-hidden rounded-2xl border border-[#3a1214]/50 bg-[#0d0405]/80 p-6 backdrop-blur-sm transition-all duration-300 hover:-translate-y-1 hover:border-[#cb5c57]/35 hover:shadow-xl hover:shadow-[#cb5c57]/8">
                      ...
                      <div className="relative">
                        ...
                        <p className="mt-2 text-sm leading-7 text-[#c9a09a]">
                    ...
                    <Reveal delay={240} from="left">
                      <div className="mt-6 space-y-3">
                        {[
                          {
                            icon: HiOutlineHeart,
                            text: t("occasionPage.customFeatureOne"),
                          },
                          {
                            icon: HiOutlineSparkles,
                            text: t("occasionPage.customFeatureTwo"),
                          },
                          {
                            icon: HiOutlinePhone,
                            text: t("occasionPage.customFeatureThree"),
                          },
                        ].map((f) => {
                          const FIcon = f.icon;
                          return (
                            ...
                            >
                              ...
                              <p className="text-sm leading-6 text-[#d4b8b0]">
                                {f.text}
                              </p>
                            </div>
                          );
