...
function AboutSection() {
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      ...
      if (petals.length > 8) setPetals((prev) => prev.slice(-8));
    }, 2200);
  ...
  return (
    <section
      ref={sectionRef}
      className="relative isolate overflow-hidden pb-16 pt-28 max-md:pt-20 max-md:pb-10"
      id="about"
    >
      ...
      >
        {/* Radial glow top */}
        <div className="absolute left-1/2 top-0 h-[70vh] w-[80vw] -translate-x-1/2 rounded-full bg-[radial-gradient(ellipse_at_center,rgba(174,29,54,0.08),transparent_68%)]" />

        {/* Gradient ribbon from left */}
        <div className="absolute left-0 top-1/3 h-[1px] w-1/3 bg-gradient-to-r from-[#d9b56f]/12 to-transparent" />
        <div className="absolute right-0 top-2/3 h-[1px] w-1/3 bg-gradient-to-l from-[#d9b56f]/12 to-transparent" />

        {/* Corner gold accents */}
        <div className="absolute left-6 top-6 h-20 w-[1px] bg-gradient-to-b from-[#d9b56f]/20 to-transparent" />
        <div className="absolute left-6 top-6 h-[1px] w-20 bg-gradient-to-r from-[#d9b56f]/20 to-transparent" />
        <div className="absolute right-6 top-6 h-20 w-[1px] bg-gradient-to-b from-[#d9b56f]/20 to-transparent" />
        <div className="absolute right-6 top-6 h-[1px] w-20 bg-gradient-to-l from-[#d9b56f]/20 to-transparent" />
        <div className="absolute bottom-6 left-6 h-20 w-[1px] bg-gradient-to-t from-[#d9b56f]/20 to-transparent" />
        <div className="absolute bottom-6 left-6 h-[1px] w-20 bg-gradient-to-r from-[#d9b56f]/20 to-transparent" />
        <div className="absolute bottom-6 right-6 h-20 w-[1px] bg-gradient-to-t from-[#d9b56f]/20 to-transparent" />
        <div className="absolute bottom-6 right-6 h-[1px] w-20 bg-gradient-to-l from-[#d9b56f]/20 to-transparent" />
      ...
      <motion.svg
        className="pointer-events-none absolute left-[10%] top-16 z-[1] h-36 w-48 opacity-15 sm:h-48 sm:w-64"
        viewBox="0 0 200 160"
        fill="none"
      ...
      <motion.svg
        className="pointer-events-none absolute right-[10%] top-24 z-[1] h-32 w-44 opacity-12 sm:h-44 sm:w-60"
        viewBox="0 0 200 160"
        fill="none"
        xmlns="http://www.w3.org/2000/svg"
      ...
      <div className="relative z-[3] mx-auto ">
        ...
        >
          ...
          <motion.div variants={itemVariants} className="mb-5 inline-flex items-center justify-center">
            <motion.div
              className="group relative inline-flex items-center gap-2.5 rounded-full border border-[#d9b56f]/25 bg-[#2a0d10]/50 px-5 py-2.5 backdrop-blur-md"
            ...
            >
              ...
              />
              <HiSparkles className="relative text-[#e8c987] text-base" />
              <span className="font-great-vibes relative text-lg tracking-[0.06em] text-[#e8c987] sm:text-xl">
                {t("about.ourStory")}
              </span>
              <HiSparkles className="relative text-[#e8c987] text-base" />
            </motion.div>
          ...
          <motion.div variants={itemVariants} className="relative">
            <motion.h2
              className="font-great-vibes text-[clamp(3rem,7vw,5.8rem)] leading-[0.92] font-normal text-[#f8ece4] [text-shadow:0_10px_30px_rgba(0,0,0,0.35),0_0_45px_rgba(125,13,36,0.12)]"
            >
              <motion.span
            ...
            <motion.div
              className="mx-auto mt-4 h-[2px] w-24 rounded-full bg-gradient-to-r from-transparent via-[#d9b56f]/50 to-transparent"
          ...
          <motion.p
            ...
            className="mx-auto mt-6 max-w-[46rem] text-[clamp(1rem,1.6vw,1.18rem)] leading-[1.95] text-[#dcc3bc] max-md:max-w-[34rem] max-md:leading-[1.8]"
          >
            {t("about.description")}
          </motion.p>
        </motion.div>
        ...
        <motion.div
          className="relative z-[2] mx-auto -mt-8 mb-6 "
        ...
        <motion.div
          className="relative z-[3] mx-auto mt-16 max-w-5xl"
          variants={containerVariants}
          initial="hidden"
          whileInView="visible"
        ...
        >
          <motion.div variants={itemVariants} className="mb-8 text-center">
            <motion.h3 className="font-great-vibes text-[2.4rem] leading-[1.1] text-[#f8ece4] sm:text-[3rem]">
              {t("about.whyUs")}
            </motion.h3>
            <motion.div
              className="mx-auto mt-3 h-[1.5px] w-16 rounded-full bg-gradient-to-r from-transparent via-[#d9b56f]/40 to-transparent"
              initial={{ scaleX: 0 }}
            ...
            {VALUES.map((val) => {
              ...
              return (
                <motion.div
                  key={val.key}
                  variants={itemVariants}
                  className="group relative overflow-hidden rounded-2xl border border-[#d9b56f]/10 bg-[#170608]/40 p-6 backdrop-blur-[6px] transition-all duration-500 hover:border-[#d9b56f]/25 hover:bg-[#1f090c]/50 hover:shadow-[0_8px_30px_rgba(217,181,111,0.06)] sm:p-8"
                >
                  {/* Hover glow */}
                  <motion.div
                  ...
                  <div className="relative flex items-start gap-5">
                    <motion.div
                      className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl border border-[#d9b56f]/15 bg-[#2a0d10]/40 text-[#d9b56f]"
                    ...
                    <div className="flex-1">
                      <h4 className="font-cormorant text-[1.15rem] font-bold text-[#f0ded6] sm:text-[1.25rem]">
                        {t(`about.value${val.key.charAt(0).toUpperCase() + val.key.slice(1)}Title`)}
                      </h4>
                      <p className="mt-1.5 text-[0.9rem] leading-[1.7] text-[#b19787]">
